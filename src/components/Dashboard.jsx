...
const Dashboard = (props) => {
    ...
    return (
        <>
            ...
            {switchPage === 'home' && <Home setSwitchPage={setSwitchPage} user={user} setUser={setUser} setCurrentPage={setCurrentPage} />}
            ...
            {switchPage === 'AddExpense' && <AddExpense user={user} setUser={setUser} />}
        </>
    )
